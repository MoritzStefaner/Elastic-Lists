package flare.physics {
	...
	public class NBodyForce implements IForce {
		...
		public function get gravitation() : Number { 
			return _g; 
		}

		public function set gravitation(g : Number) : void { 
			_g = g; 
		}
		...
		public function set maxDistance(d : Number) : void { 
			_max = d; 
		}
		...
		public function set minDistance(d : Number) : void { 
			_min = d; 
		}
